...
new class extends Component {
    ...
    public function saveDraft(): void
    {
        ...
        session()->flash('success', 'Newsletter saved as a draft.');
    ...
    public function submit(): void
    {
        ...
        if ($this->deliveryMode === 'now') {
            ...
            session()->flash('success', 'Newsletter scheduled successfully.');
        }
        ...
        <form wire:submit="submit" class="space-y-6">
            ...
            <div>
                ...
                <div wire:ignore class="mt-1">
                    <input id="newsletter-content" type="hidden">
                    <trix-editor
            ...
            <div class="flex flex-wrap gap-3 border-t border-gray-200 pt-6">
                ...
                >
                    {{ $deliveryMode === 'scheduled' ? 'Schedule Newsletter' : 'Send Newsletter' }}
                </button>
                <button
                    type="button"
